...
public class SceneGraph extends JPanel {
    ...
    public void updateFrame() {
        ...
        w1_2.setRotation(frameNumber*0.9);
        w1_1.setRotation(frameNumber*0.9);


        w2_2.setRotation(frameNumber*0.9);
        w2_1.setRotation(frameNumber*0.9);

        w3_2.setRotation(frameNumber*0.9);
        w3_1.setRotation(frameNumber*0.9);
